...
if ( defined('CAKE_CORE_INCLUDE_PATH') || defined('CAKE')) {
	class QdsmtpBranch extends Component{}
}else{
	class QdsmtpBranch{}
}
...
*/
	...
	function sendData(){
		...
		$items[] = array( 'DATA_CONTENT' , $this->smtpEscape($this->request->data).$this->smtpLFC . '.' );
	...
	function makeData( $to , $subject , $message , $header=null , $option=null ){
		...
		return $this->request->data = $head . $this->smtpLFC . $this->smtpLFC . $message ;
	}
